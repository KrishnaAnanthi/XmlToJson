...
public class SoapClient {
	public String myHandler(InputStream inputStream, OutputStream outputStream, Context context) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(userEnteredNumber, password, agentId),
					url);
			// Process the SOAP Response
			String soapResponseStr = printSOAPResponse(soapResponse);
			logger.log("\nsoapResponseStr : " + soapResponseStr);
			soapConnection.close();
			String jsonOutput = convertSoapToJson(soapResponseStr);
			logger.log("\njson format : " + jsonOutput);
